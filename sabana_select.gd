...
func _ready():
	...
	$level2Button.pressed.connect(SceneController.level2Savanna_button_pressed)
	$level3Button.pressed.connect(SceneController.level3Savanna_button_pressed)
	$level4Button.pressed.connect(SceneController.level4Savanna_button_pressed)
	$level5Button.pressed.connect(SceneController.level5Savanna_button_pressed)
	...
	for i in range(2, 6):
		...
		var level_passed_var_name = "isSavannaLvlPassed" + str(i)
